...
- **只有 pi-ai 路由可以手工声明**：自定义提供方卡片写入 `llm-pi-ai`——唯一一个其 profile 自带协议选择、描述整个提供方的 namespace。DeepSeek 官方路由改经普通的新增流程添加，其 profile 形状由适配器固定。
