/**
 * Models settings plugin, browser half. It registers the Models page plus the
 * ordered internal-testing notice of product onboarding, whose UI shares this
 * package's modal wrapper. The Host settings and credential contracts stay
 * behind their existing wire APIs. Export discipline:
