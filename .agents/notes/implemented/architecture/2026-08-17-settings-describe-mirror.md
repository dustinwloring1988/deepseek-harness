...
This decision updates the browser read and invalidation mechanics recorded by [Host-backed Web preferences](../bug-fix/2026-08-06-host-backed-web-preferences.md) and [plugin-owned settings surface](2026-08-12-plugin-owned-settings-surface.md), while preserving their preference-ownership and namespace-exposure decisions. It replaced the direct settings-read description of the first-run DeepSeek credential step ([archived](../../archived/feature/2026-07-30-deepseek-onboarding-credential-setup.md); since removed by [dormant official DeepSeek provider](../feature/2026-08-21-dormant-official-deepseek-provider.md)), whose join derived its settings half from this mirror.
